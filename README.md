# admin_dashbord Project
 
## Description
Health records, appointments, communication, Users, patients, doctors, and resources, empower admin for better healthcare management.
...
1. Clone the repository to your local machine:
    ```bash
    git clone https://github.com/BasemYahia402/admin_dashbord.git
